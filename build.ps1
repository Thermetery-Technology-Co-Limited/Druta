...
function Get-SourceSnapshot {
    $paths = @(
        ...
        'RELEASE-NOTES-1.3.0.md', 'RELEASE-NOTES-1.4.0.md', 'RELEASE-NOTES-1.4.1.md',
        'experiments/nvtune-titan-xp-driver-roundtrip-20260914.json', 'MAXWELL-PASCAL-VALIDATION.md', 'BLACKWELL-VALIDATION.md',
