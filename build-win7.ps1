...
try {
    ...
    & $Python src/druta/tools/package_source.py snapshot --root $root --snapshot $sourceSnapshot
    ...
    & $Python src/druta/tools/package_source.py package --root $root --snapshot $sourceSnapshot --bundle $bundle
