...
# the contractor's binary, it carries its own signed kernel driver, and its
# licensing is not ours to redistribute. So it is treated as an external
    ...
    if not exe:
        ...
        if pin:
            ...
            av.reason = (
                ...
                f"separate tool with its own signed kernel driver - so it has "
