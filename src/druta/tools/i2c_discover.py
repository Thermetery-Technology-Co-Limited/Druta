...
Usage:
    python -m druta.tools.i2c_discover                 # ports 0-7, common addresses
    python -m druta.tools.i2c_discover --ports 0,1,2   # narrow the sweep
    python -m druta.tools.i2c_discover --full          # every 7-bit address, slower
